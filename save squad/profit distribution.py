...
# Input data
data = {
    'memberid': ['mowen', 'ray', 'phile', 'sheila', 'martha', 'hamisi', 'emmanuel', 'bariki'],
    'savings': [1000000, 1300000, 700000, 1000000, 900000, 1000000, 1000000, 1000000],
    'loanno': [4, 2, 5, 0, 3, 3, 2, 4],
    'loantaken': [800000, 500000, 1300000, 0, 2000000, 600000, 700000, 800000],
    'interest': [80000, 50000, 130000, 0, 200000, 60000, 70000, 80000],
    'latepay': [1, 0, 2, 0, 1, 1, 2, 3],
    'fines': [15000, 5000, 40000, 5000, 10000, 10000, 20000, 30000]
}
